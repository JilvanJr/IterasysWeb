...
public class RegisterMap {
	...
	public Element validaPrimeiroNome = new Element("h2", ByValue.css, 0);
	public Element validaPrimeiroValorH3 = new Element("h3", ByValue.css, 0);
	public Element validaPrimeiroValorSpan = new Element("h3 > span", ByValue.css, 0);
	public Element validaSegundoNome = new Element("h2", ByValue.css, 1);
	public Element validaSegundoValorH3 = new Element("h3", ByValue.css, 1);
